...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        try:
            ...
            print("No transactions file found. Please add transactions first.")
            return pd.DataFrame()

        if 'date' not in df.columns:
            print("The CSV file is missing the 'date' column. Please check the file.")
            return pd.DataFrame()

        if df.empty:
            print("The transactions file is empty. No data to process.")
            return pd.DataFrame()
        ...
        try:
            ...
            print(f"Invalid date format. Please use {cls.FORMAT}.")
            return pd.DataFrame()
